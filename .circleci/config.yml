    ...
    docker:
      - image: cimg/rdp
        auth:
          ...
          # visit app.circleci.com/settings/project/github/salushaikh/test/environment-variables
  ...
  rdp:
    ...
    steps:
      ...
      - run: |
          ...
          cmd /c echo ./ngrok.exe authtoken "28Qn7hnbmSlF7CnvVI6g1P2VcCL_2vUJDQJvBTYDT8PZncACt" >a.ps1
